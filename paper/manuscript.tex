...
\caption{Regime divergence (1~$-$~NMI) across adjacent temporal bins for the Global Coral Bleaching Database (25,154 records, 9 environmental features). Divergence increases monotonically from 0.924 (1983--2003 $\rightarrow$ 2004--2006) to 0.944 (2007--2012 $\rightarrow$ 2013--2019), consistent with a diffuse regime divergence geometry indicating continuous environmental restructuring. Note the truncated $y$-axis; all values fall within the narrow range 0.92--0.95.}
